...
public sealed class BlueByrdpipPet : MonsterModel
{
    ...
    {
        string skinName = !this.IsMutable ? Relics.NestBirdpyps.BlueByrdpip.SkinOptions[0] : this.Creature.PetOwner?.GetRelic<Relics.NestBirdpyps.BlueByrdpip>()?.Skin ?? Relics.NestBirdpyps.BlueByrdpip.SkinOptions[0];
