...
namespace TheValkyrie.TheValkyrieCode.MetricsUpload;

public static class ValkyrieMetrics
{
    private static readonly RunMetricsUploader<RunMetrics> Uploader = new(
        new MetricsUploaderConfig
        {
            ModName = "TheValkyrie",
            EndpointUrl = "https://budijikttwifyfymwhjh.supabase.co/rest/v1/runs",
            ApiKey = "sb_publishable_BFuHVZ2z6ZZkxxKRoGM95A_9ucPMPxs",
            ModVersionProvider = MainFile.GetModVersion,
            IsOwnCharacter = e => e is Character.TheValkyrie,
            AllowedAssemblies = new HashSet<Assembly>
            {
                typeof(Character.TheValkyrie).Assembly,
