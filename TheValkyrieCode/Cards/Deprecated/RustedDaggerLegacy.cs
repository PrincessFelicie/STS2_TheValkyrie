...
//todo settings toggle to have either legacy Fatal rusted dagger, or The Scythe style rusted dagger
/*public class RustedDaggerLegacy : TheValkyrieCard
{
    ...
    public RustedDaggerLegacy() : base(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
